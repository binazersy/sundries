...
//!---------------------------------------------------------
//! @brief Thread-safe queue old.
//! @detail Using std::queue<>. Covered in chapter 4.
//!---------------------------------------------------------
//! 
template<typename T>
...
//!---------------------------------------------------------
//! @brief Simple queue
//! @detail Simple single-threaded queue using custom list
//!---------------------------------------------------------
//! 
template<typename T>
class simple_queue
...
//!---------------------------------------------------------
//! @brief Simple queue with dummy
//! @detail For efficiency, initialized with dummy node
//!---------------------------------------------------------
//! 
template<typename T>
...
//!---------------------------------------------------------
//! @brief Thread-safe ver. of @ref simple_queue_dummy
//!---------------------------------------------------------
//! 
template<typename T>
...
//!---------------------------------------------------------
//! @brief Waitable ver. of @ref threadsafe_queue66
//!---------------------------------------------------------
//! 
template<typename T>
